 ...
 */
?>
<form dir="ltr" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>" method="get">
	<?php
		...
		<input dir="rtl" type="search" name="s" class="search-field" placeholder="<?php echo esc_attr($magbook_search_form); ?>" autocomplete="off" />
